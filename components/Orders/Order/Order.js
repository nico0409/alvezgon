...
function AddressModal(props) {
  const { showModal, setShowModal, addressShiping, title } = props;
  ...
  return (
    ...
    >
      ...
      <div>
        <p>{addressShiping.title}</p>
        <p>{addressShiping.city}</p>
        <p>{addressShiping.province}</p>
        <p>
          {addressShiping.street}, {addressShiping.number}{" "}
          {addressShiping.postalCode}
        </p>
        <p>{addressShiping.betweenStreets}</p>
      </div>
    </BasicModal>
  );
}
